...
public class Movie : IMovie
{
    ...
    public int CompareTo(IMovie another)
    {
        ...
        // Using CompareTo method from String class for case-sensitive comparison
        int result = currentTitle.CompareTo(anotherTitle);
    ...
    new public string ToString()
    {
        ...
        //Pre-condition: nil
        //Post-condition: A string containing the title, genre, classification, duration, and the number of available copies of this movie has been
        return "Title: " + title + " Genre: " + genre + " Classification: " + classification + " Duration: " + duration + " Copies: " + availablecopies;
    }
}
